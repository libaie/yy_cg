...
/**
 * DTO that holds mapped product fields before they are persisted as
 * {@link com.ruoyi.yy.domain.YyStandardProduct}.
 * <p>
 * Mirrors the YyStandardProduct structure but uses plain Java types
 * (and {@code List<String>} for compound fields where appropriate) to
 * decouple the mapping engine from JPA/MyBatis entity constraints.
 * </p>
 *
 * @author fdAgent
 */
